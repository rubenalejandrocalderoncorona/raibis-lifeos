...
type CustomEntityType struct {
	...
	HasDetailView   bool      `json:"has_detail_view"`   // true = individual page with widgets
	HasSubentities  bool      `json:"has_subentities"`   // true = records can have child records of same type
